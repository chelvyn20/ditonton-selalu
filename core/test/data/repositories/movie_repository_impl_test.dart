...
void main() {
  ...
  group('Now Playing Movies', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        verify(mockMovieRemoteDataSource.getNowPlayingMovies());
        verify(
            mockMovieLocalDataSource.cacheNowPlayingMovies([testMovieCache]));
      });
    ...
    group('when device is offline', () {
      ...
      test('should return cached data when device is offline', () async {
        when(mockMovieLocalDataSource.getCachedNowPlayingMovies())
            .thenAnswer((_) async => [testMovieCache]);

        final result = await repository.getNowPlayingMovies();

        verify(mockMovieLocalDataSource.getCachedNowPlayingMovies());
        final resultList = result.getOrElse(() => []);
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockMovieLocalDataSource.insertMovieWatchlist(testMovieTable))
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockMovieLocalDataSource.removeMovieWatchlist(testMovieTable))
